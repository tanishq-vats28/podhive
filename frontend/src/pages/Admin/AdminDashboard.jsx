...
import { AlertTriangle, Calendar, CheckCircle, Clock, Filter, Search, User, MapPin, DollarSign, TrendingUp, Users, Mic, Camera } from 'lucide-react';
          ...
          <div className="mb-8">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              <div>
                ...
                <p className="text-gray-600 text-lg">Monitor and manage the entire PodHive platform</p>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 hover:shadow-lg transition-all duration-300 group">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-gray-500 text-sm font-medium">Pending Studios</p>
                ...
                <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
                  ...
                  <div className="space-y-4">
                    ...
                    >
                      ...
                      <div>
                        <h3 className="font-semibold text-gray-900">Review Pending Studios</h3>
                        <p className="text-gray-600 text-sm">Approve or deny studio submissions</p>
                      </div>
                    </Link>
                    ...
                    >
                      ...
                      <div>
                        <h3 className="font-semibold text-gray-900">Manage All Bookings</h3>
                        <p className="text-gray-600 text-sm">View and manage platform bookings</p>
                      </div>
                    </Link>
                  </div>
                </div>
                    ...
                    {pendingStudios.length > 0 ? (
                      ...
                      <div className="p-4 bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-xl">
                        <div className="flex items-center text-green-800">
                          ...
                          <div>
                            <span className="font-semibold">No pending studios to approve</span>
                            <p className="text-sm text-green-600 mt-1">All submissions are up to date</p>
                          </div>
                        </div>
                      </div>
                    )}
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center text-blue-800">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-blue-600 mt-1">{upcomingBookings.length} upcoming sessions</p>
                          </div>
                        </div>
                      </div>
                    </div>
                        ...
                        {filteredBookings.slice(0, 10).map((booking) => (
                          <tr key={booking._id} className="hover:bg-gray-50">
                            ...
                            <td className="px-6 py-4 whitespace-nowrap">
                              ...
                              <div className="text-sm text-gray-500">
                                {booking.hours ? booking.hours.map(h => formatHour(h)).join(', ') : 'No hours specified'}
                              </div>
                            </td>
                            <td className="px-6 py-4 whitespace-nowrap">
                            ...
                            <td className="px-6 py-4 whitespace-nowrap">
                              <span className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full ${
                                isAfter(parseISO(booking.date), now) || format(parseISO(booking.date), 'yyyy-MM-dd') === format(now, 'yyyy-MM-dd')
                                  ? 'bg-blue-100 text-blue-800' 
                                  : 'bg-gray-100 text-gray-800'
                              }`}>
                                {isAfter(parseISO(booking.date), now) || format(parseISO(booking.date), 'yyyy-MM-dd') === format(now, 'yyyy-MM-dd') ? 'Upcoming' : 'Completed'}
                              </span>
                            </td>
                          </tr>
                        ))}
