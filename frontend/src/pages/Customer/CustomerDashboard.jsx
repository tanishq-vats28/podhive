...
import { Mic, Calendar, Star, User, TrendingUp, Clock, MapPin, Camera } from 'lucide-react';
      ...
      <div className="flex-1 p-4 lg:p-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-gray-600 text-lg">Ready to create amazing content?</p>
              </div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
              ...
              <div className="space-y-4">
                ...
                >
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900">Browse Studios</h3>
                    <p className="text-gray-600 text-sm">Find the perfect studio for your next recording</p>
                  </div>
                </Link>
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">View and manage your studio bookings</p>
                  </div>
                </Link>
              </div>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
              ...
              {loading ? (
                  ...
                  {bookings.slice(0, 3).map((booking) => (
                    <div key={booking._id} className="flex items-center p-4 bg-gray-50 rounded-xl">
                      ...
                      <div className="flex-1">
                        <h4 className="font-medium text-gray-900">{booking.studio?.name}</h4>
                ...
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-600 mb-4">Start by browsing our amazing studios</p>
                  <Link 
                    to="/studios"
          ...
          <div className="bg-gradient-to-r from-indigo-600 to-purple-600 p-8 rounded-2xl text-white">
            <h2 className="text-2xl font-bold mb-6">Pro Tips for Great Recordings</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-white/10 backdrop-blur-sm p-6 rounded-xl">
                ...
                <p className="text-indigo-100 text-sm">Arrive 15 minutes early to test all equipment and ensure everything works perfectly.</p>
              </div>
              ...
              <div className="bg-white/10 backdrop-blur-sm p-6 rounded-xl">
                ...
                <p className="text-indigo-100 text-sm">Prepare your talking points and questions in advance to make the most of your studio time.</p>
              </div>
              ...
              <div className="bg-white/10 backdrop-blur-sm p-6 rounded-xl">
                ...
                <p className="text-indigo-100 text-sm">Help other creators by leaving honest reviews about your studio experience.</p>
              </div>
            </div>
          </div>
        </div>
